...
export default function AddLiquidityFaildModal(props) {
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "AddLiquidityFaildModal")}
      {...rest}
    >
      <Flex
        gap="7px"
      ...
      >
        ...
        <Text
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="Add Liquidity Failed"
          {...getOverrideProps(overrides, "Add Liquidity Failed")}
        ></Text>
        <Text
          fontFamily="Inter"
          fontSize="15px"
