...
export default function SwapFaildModal(props) {
  ...
  React.useEffect(() => {
    if (timer > 0) {
      ...
      props?.setSwapFailModalOpen(false);
    }
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "SwapFaildModal")}
      {...rest}
    >
      <Flex
        gap="7px"
      ...
      >
        ...
        <Text
          ...
          {...getOverrideProps(overrides, "Swap Failed")}
        ></Text>
        <Text
          fontFamily="Inter"
          fontSize="15px"
