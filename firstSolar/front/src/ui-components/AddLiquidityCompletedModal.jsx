...
export default function AddLiquidityCompletedModal(props) {
  ...
  React.useEffect(() => {
    if (timer > 0) {
      ...
      props?.setAddLiquiditySuccessModalOpen(false);
    }
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "AddLiquidityCompletedModal")}
      {...rest}
    >
      <Flex
        gap="7px"
      ...
      >
        ...
        <Text
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children="Add Liquidity Completed"
          {...getOverrideProps(overrides, "Add Liquidity Completed")}
        ></Text>
        <Text
          fontFamily="Inter"
          fontSize="15px"
