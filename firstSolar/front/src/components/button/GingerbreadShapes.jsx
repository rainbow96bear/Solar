...
export function GingerbreadShapes({ isHover, isPress, mouseX, mouseY }) {
  ...
  return (
    ...
    >
      ...
      <MotionConfig transition={transition}>
        ...
        >
          <Gingerbread position={[0.01, -1.54, 0]} scale={[0.55, 0.55, 0.55]} />
        </motion.group>
      </MotionConfig>
    </Canvas>
  );
...
export function Material() {
  return <meshPhongMaterial color="#fff" specular="#FBFBF6" shininess={10} />;
}
