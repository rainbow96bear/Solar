...
export function RocketShapes({ isHover, isPress, mouseX, mouseY }) {
...
export function Lights() {
  return (
    <>
      ...
      <spotLight color="#FBFBF6" position={[15, 10, -2]} intensity={1.3} />
      <spotLight color="#FBFBF6" position={[15, 10, 5]} intensity={0.7} />
      <spotLight color="#FBFBF6" position={[5, -10, 5]} intensity={0.8} />
    </>
  );
}
