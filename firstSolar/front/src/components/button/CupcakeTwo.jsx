...
Command: npx gltfjsx@6.1.11 cupcakeTwo.glb
*/

import React, { useRef } from "react";
import { useGLTF } from "@react-three/drei";

export function CupcakeTwo(props) {
  const { nodes, materials } = useGLTF("./gltf/cupcakeTwo.glb");
  return (
    <group {...props} dispose={null} scale={[5, 5, 5]}>
      <mesh
        geometry={nodes.cherry001.geometry}
        material={materials.cherry}
        position={[0.11, 0.38, 0.18]}
...
useGLTF.preload("./gltf/cupcakeTwo.glb");
