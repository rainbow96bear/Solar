...
contract LiquidityPool is ERC20 {
  ...
  function swapTokens(
    ...
    DFSPairAirDrop(address(token1),_amountIn.mul(3).div(1000),address(token2),0);
  ...
  function addLiquidity(
    ...
    if (_reserve1 > 0 || _reserve2 > 0) {
      ...
      DFSPairAirDrop(address(token1),_amountToken1.mul(3).div(1000),address(token2),_amountToken2.mul(3).div(1000));
    }
    /*
  ...
  function DFSPairAirDrop(address _token1, uint256 _amountToken1, address _token2, uint256 _amountToken2) public {
